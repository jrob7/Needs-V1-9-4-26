...
SERVICE_HINT_WORDS = [
    ...
    "handyman","cleaner","housekeeping","maid","house cleaning","house cleaner",
    "appliance","dryer","washer","washing machine","dishwasher","refrigerator","fridge",
    "microwave","oven","stove","garbage disposal","freezer","ice maker","appliance repair",
    "floor","flooring","hardwood","carpet","laminate","vinyl floor","tile floor",
    "carpet cleaning","upholstery cleaning","carpet cleaner",
    "junk removal","junk hauling","trash removal","hauling","debris removal",
    "pest control","exterminator","termite","rodent","ant","roach","bed bug","infestation",
    "pressure washing","power washing","pressure wash","power wash",
    "window cleaning","window washer","window cleaner",
    "pool service","pool cleaning","pool maintenance","pool cleaner",
    "garage door","garage door repair","garage door opener","garage door service",
    "locksmith","locked out","lock change","rekey","key copy",
    "auto repair","auto shop","brake service","diagnostic","tune up",
    "landscaper","landscaping","lawn","lawn care","lawn mowing","mow","hedge","yard","garden","sprinkler",
    ...
    # Automotive
    "auto detailing","car detailing","car wash","detail","detailing",
