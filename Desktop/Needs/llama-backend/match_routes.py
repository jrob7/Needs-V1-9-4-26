...
CATEGORY_KEYWORDS = {
    ...
    "Roofing":           ["roof", "roofing", "roofer", "shingle", "shingles", "gutter",
                            "fascia", "soffit", "flashing", "roof repair", "roof leak",
                            "roof replacement", "flat roof", "metal roof", "tile roof"],
    ...
    "Flooring":          ["floor", "flooring", "hardwood", "hardwood floor", "carpet",
                            "tile floor", "laminate", "vinyl floor", "lvp", "lvt",
                            "subfloor", "floor installation", "floor repair",
                            "refinish floor", "floor refinishing"],
    "Moving":            ["moving", "movers", "relocation", "haul furniture",
                            "move out", "move in"],
    # Automotive
    "Mechanic":          ["mechanic", "engine", "transmission", "oil change",
                            "car repair", "auto repair", "auto shop", "car service",
                            "check engine", "alternator", "car battery", "brake",
                            "brake service", "diagnostic", "tune up"],
